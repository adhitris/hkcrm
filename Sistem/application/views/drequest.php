            ...
            <div class="span12">
                ...
                <div class="portlet box blue">
                    <div class="portlet-title">
                        <div class="caption"><i class="icon-edit"></i>DETAIL ORDER NUMBER (
                            <?php
                              foreach ($req->result() as $row) {   
                               echo"
                               $row->REQUEST_ORDER_HDR_FK";
                                }?> )
                        </div>
                        <div class="tools">
                            ...
                            <?php
                              foreach ($req->result() as $row) {   
                               ...
                               <tr>
                                ...
                                <td>$row->UNIT</td>
                                <td><a href='".base_url()."/assets/uploads/request/$row->SAMPLE_UPLOAD' target='_blank' class='btn btn-sm blue'>View</a></td>
