    ...
    <div class="container-fluid">
        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <h3 class="page-title">
                        Your Complaint<small> manage complaint here</small>
                </h3>
                <ul class="breadcrumb">
                        <li>
                                <i class="icon-home"></i>
            ...
            <div class="span12">
                ...
                <div class="portlet box blue">
                    <div class="portlet-title">
                        <div class="caption"><i class="icon-edit"></i>Complaint</div>
                        <div class="tools">
                    ...
                    <div id="responsive" class="modal hide fade" tabindex="-1" data-width="760">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="content">       
                                <!-- BEGIN ADD NEW FORM -->
                                <?php echo form_open_multipart("Complaint/addDBcomplaint"); ?>
                                    <form class="form-vertical register-form">
                                    <div class="form-horizontal form-view">
                                        <div class="row-fluid">
                                            <div class="span6">
                                                <div class="control-group">
                                                    <label class="control-label" for="firstName">COMPLAINT NUMBER : </label>
                                                    <div class="controls">
                                                        <?php
                                                         $date=rand(1111,9999);
                                                        ?>
                                                        <span class="text bold"><?php echo"CP-".$date;?></span>
                                                        <input class="m-wrap placeholder-no-fix" type="hidden" name="complaint_id" value="<?php echo$date;?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                            <div class="span6">
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <span class="text bold"><?php echo date('d-M-Y');?></span>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                        ...
                                        <div class="control-group">
                                            <label class="control-label visible-ie8 visible-ie9">SO NUMBER</label>
                                            <div class="controls">
                                                <div class="input-icon left">
                                                    <i class="icon-asterisk"></i>
                                                    <input class="m-wrap placeholder-no-fix" type="text" placeholder="SO_NUMBER" name="so_number" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <textarea class="span6 m-wrap" name="note" rows="6"></textarea>
                                        </div>
                                        </div>
                                        <div class="control-group">
                                        ...
                                        <div class="control-group">
                                            <label class="control-label visible-ie8 visible-ie9">PIC NAME</label>
                                            <div class="controls">
                                                <div class="input-icon left">
                                                    <i class="icon-asterisk"></i>
                                                    <input class="m-wrap placeholder-no-fix" type="text" placeholder="PIC NAME" name="pic_name" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label visible-ie8 visible-ie9">PIC NUMBER</label>
                                            <div class="controls">
                                                <div class="input-icon left">
                                                    <i class="icon-asterisk"></i>
                                                    <input class="m-wrap placeholder-no-fix" type="text" placeholder="PIC NUMBER" name="pic_number" />
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="portlet-body flip-scroll">
                        ...
                        <table class="table table-striped table-hover table-bordered flip-content" id="sample_editable_1">
                            ...
                            <tbody>
                            <?php
                              foreach ($listcomplaint->result() as $row) {   
