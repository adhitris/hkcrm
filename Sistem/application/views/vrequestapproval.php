            ...
            <div class="span12">
                ...
                <div class="portlet box blue">
                    <div class="portlet-title">
                        <div class="caption"><i class="icon-edit"></i>Request Approval </div>
                        <div class="tools">
                    ...
                    <div class="portlet-body flip-scroll">
                        <div class="clearfix">
                         <div class="alert alert-success">
                             Click HRD ID NUMBER for Detail
                         </div>
                        </div>
                        <table class="table table-striped table-hover table-bordered flip-content" id="sample_editable_1">
                            ...
                            <tbody>
                            <?php
                              foreach ($listrequestapproval->result() as $row) {   
                               echo"
                               <tr class=''>
                                <td>
                                    <a href='".base_url()."RequestApproval/detail/$row->REQUEST_ORDER_HDR_ID'>$row->REQUEST_ORDER_HDR_ID</a>
                                </td>
                                ...
                                <td>
                                    <div class='btn-group'>";
                                    if($row->STATUS=='request' || $row->STATUS==''){
                                        echo"
                                        <a class='btn blue' href='#' data-toggle='dropdown'>Response
                                        </a>
                                        <ul class='dropdown-menu bottom-up'>
                                            <li><a href='#' onclick='approveData($row->REQUEST_ORDER_HDR_ID)'><i class='icon-check'></i> Approve</a></li>
                                            <li><a href='#' onclick='rejectData($row->REQUEST_ORDER_HDR_ID)'><i class='icon-trash'></i> Reject</a></li>
                                        </ul>";
                                    }
    ...
    <script>
        ...
        function approveData(id){
            ...
            function(){
                ...
                $.ajax({
                    url : "<?php echo base_url(); ?>/RequestApproval/approve",
                    type: "POST",
                    data : formData,
        ...
        function rejectData(id){
            ...
            function(){
                ...
                $.ajax({
                    url : "<?php echo base_url(); ?>/RequestApproval/reject",
                    type: "POST",
                    data : formData,
                    success: function(data, textStatus, jqXHR)
                    {
